			...
			<section id="main" class="wrapper">
				<div class="container">
					<header class="major special">
						...
						<p>DATA SELURUH BAHAN BAKU DI WARKOP MURAH TAPI GAK MURAHAN </p>
					</header>
						<!-- Table -->
						<section>
							<ul class="actions">
								<li><a href="tambah_bahan.php" class="button special">TAMBAH</a></li>
								...
								<table>
									...
									<tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $row_Recordset1['kategori_bhn']; ?></td>
                                        <td><?php echo $row_Recordset1['jumlah']; ?></td>
                                        <td colspan="2"><li><a href="edit_bahan.php?kd_bhn=<?php echo $row_Recordset1['kd_bhn']; ?>" class="button">Edit</a></li></td>
                                        <td><li><a href="hapus_bahan.php?kd_bhn=<?php echo $row_Recordset1['kd_bhn']; ?>" class="button alt">Hapus</a></li></td>
